...
//    STOP_THREAD(video::capture1(),             "VideoCapture1",     15)
//    STOP_THREAD(fpt::preprocessor(),           "Preprocessor",      15)
//    STOP_THREAD(fpt::detector(),               "Detector",          15)
//    STOP_THREAD(fpt::tracker(),                "Tracker",           15)
