...
#include "database/postgres_driver.h"
...
private:
    ...
    db::postgres::Driver::Ptr _connect;
    db::postgres::Transaction::Ptr _transact1;
    db::postgres::Transaction::Ptr _transact2;
    ...
    //QList<db::postgres::Driver::Ptr> _connections;
};
